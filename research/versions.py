...
SYSTEM_VERSION_BY_MODE = CANONICAL_SYSTEM_VERSION_BY_MODE

CANONICAL_SYSTEM_VERSIONS = tuple(CANONICAL_SYSTEM_VERSION_BY_MODE.values())
# Retained so saved traces from the retired experiment remain interpretable.  This
# system is deliberately absent from SYSTEM_VERSION_BY_MODE and cannot be run.
ARCHIVED_EXPERIMENTAL_SYSTEM_VERSIONS = (PRIOR_GUIDED_SYSTEM_VERSION,)
...
ARCHIVED_EXPERIMENTAL_VERSION_LABELS = {
